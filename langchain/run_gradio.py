...
os.system("openxlab model download --model-repo \'OpenLMLab/InternLM-chat-7b-8k\'")
download(model_repo='OpenLMLab/InternLM-chat-7b-8k',  model_name='InternLM-chat-7b-8k', output='/home/xlab-app-center/OpenLMLab/InternLM-chat-7b-8k')
# 设置环境变量
...
def load_chain():
    ...
    model_path='/home/xlab-app-center/OpenLMLab/InternLM-chat-7b-8k'
