...
os.system("pip install sqlite3 == 3.35.0;pip install pypdf;pip install pdfminer.six;pip install opencv-python;pip install pytesseract;pip install python-docx")
