...
更通俗的解释：服务器端加载模型，客户端使用模型，API连接服务器客户端

# 部署教程：

[Tutorial/lmdeploy/lmdeploy.md at camp1 · InternLM/Tutorial · GitHub**LLM Tutorial. Contribute to InternLM/Tutorial development by creating an account on GitHub.**![](https://csdnimg.cn/release/blog_editor_html/release2.3.7/ckeditor/plugins/CsdnLink/icons/icon-default.png?t=O83A)https://github.com/InternLM/Tutorial/blob/camp1/lmdeploy/lmdeploy.md](https://github.com/InternLM/Tutorial/blob/camp1/lmdeploy/lmdeploy.md "Tutorial/lmdeploy/lmdeploy.md at camp1 · InternLM/Tutorial · GitHub")
...
> InternLM2.5 7B模型为bf16，LMDpeloy推理精度为bf16的7B模型权重需要占用**14GB**显存；
>
> **但是显存占用22G，多占用10G**
>
> 原因是：
>
> mdeploy默认设置cache-max-entry-count为0.8，即kv cache占用剩余显存的80%；
>
...
[![](https://github.com/InternLM/Tutorial/raw/camp1/lmdeploy/img/add4.png)](https://github.com/InternLM/Tutorial/blob/camp1/lmdeploy/img/add4.png)
...
[![](https://github.com/InternLM/Tutorial/raw/camp1/lmdeploy/img/quant.drawio.png)](https://github.com/InternLM/Tutorial/blob/camp1/lmdeploy/img/quant.drawio.png)
...
[![](https://github.com/InternLM/Tutorial/raw/camp1/lmdeploy/img/3.png)](https://github.com/InternLM/Tutorial/blob/camp1/lmdeploy/img/3.png)

### TritonServer推理+API服务

[](https://github.com/InternLM/Tutorial/blob/camp1/lmdeploy/lmdeploy.md#tritonserver%E6%8E%A8%E7%90%86api%E6%9C%8D%E5%8A%A1)
...
[![](https://github.com/InternLM/Tutorial/raw/camp1/lmdeploy/img/14.png)](https://github.com/InternLM/Tutorial/blob/camp1/lmdeploy/img/14.png)
...
[![](https://github.com/InternLM/Tutorial/raw/camp1/lmdeploy/img/15.png)](https://github.com/InternLM/Tutorial/blob/camp1/lmdeploy/img/15.png)
...
[![](https://github.com/InternLM/Tutorial/raw/camp1/lmdeploy/img/18.png)](https://github.com/InternLM/Tutorial/blob/camp1/lmdeploy/img/18.png)
...
[![](https://github.com/InternLM/Tutorial/raw/camp1/lmdeploy/img/6.png)](https://github.com/InternLM/Tutorial/blob/camp1/lmdeploy/img/6.png)

列并行

[![](https://github.com/InternLM/Tutorial/raw/camp1/lmdeploy/img/7.png)](https://github.com/InternLM/Tutorial/blob/camp1/lmdeploy/img/7.png)

行并行

遇到Aborted (core dumped)
